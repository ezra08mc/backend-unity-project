...
type TodoService interface {
	...
	GetAllActive(limit, offset int) ([]dto.TodoResponse, error)
	GetAllTrash(limit, offset int) ([]dto.TodoResponse, error)
	...
	GetActiveByUserID(userID int, limit, offset int) ([]dto.TodoResponse, error)
	GetTrashByUserID(userID int, limit, offset int) ([]dto.TodoResponse, error)
